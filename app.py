...
def refraction_examination():
    ...
    with st.form("final_form"):
        ...
        if save_final:
            try:
                # Save final values to session state before database insertion
                st.session_state.refraction.update({
                    'final_od_sph': final_od_sph,
                    'final_od_cyl': final_od_cyl,
                    'final_od_axis': final_od_axis,
                    'final_os_sph': final_os_sph,
                    'final_os_cyl': final_os_cyl,
                    'final_os_axis': final_os_axis
                })
